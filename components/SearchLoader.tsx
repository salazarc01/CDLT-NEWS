  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setProgress(prev => {
        ...
        // Salto aleatorio pero rápido para simular carga de datos masiva
  ...
  return (
    <div className="fixed inset-0 z-[200] bg-black flex flex-col items-center justify-center p-8 overflow-hidden animate-in fade-in duration-300">
      ...
      <div className="relative z-10 w-full max-w-xs flex flex-col items-center">
        {/* Radar Icon with High Intensity */}
        ...
        <h2 className="text-white font-black text-[16px] uppercase tracking-[0.6em] mb-8 text-center drop-shadow-[0_0_10px_rgba(59,130,246,0.5)]">
          CARGANDO NEWS
        </h2>

        {/* Progress Bar with Aesthetically Pleasing UI */}
        <div className="w-full relative px-4">
          ...
          <div className="mt-4 flex justify-center items-center gap-2">
            <span className="text-blue-500 font-black text-[24px] tracking-tighter serif-font italic">
              {Math.round(progress)}%
            </span>
            <span className="text-[10px] font-black text-zinc-600 uppercase tracking-widest">Sincronizado</span>
          </div>
        </div>
      </div>
